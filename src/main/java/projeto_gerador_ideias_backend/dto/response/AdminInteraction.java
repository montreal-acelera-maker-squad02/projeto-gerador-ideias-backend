...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Interação completa entre usuário e assistente com informações do usuário (para admin)")
public class AdminInteraction {
    ...
    @Schema(description = "IP do usuário que fez a interação", example = "192.168.1.1")
